import{$ as e,A as t,F as n,G as r,I as i,J as a,L as o,M as s,O as c,Q as l,R as u,T as d,W as f,X as p,Y as m,Z as h,_ as g,a as _,at as v,c as y,d as b,dt as ee,et as x,f as S,ht as C,it as w,j as te,k as T,nt as E,r as ne,tt as D,u as re,ut as ie,v as O}from"./BAUNE5Zx.js";import{s as ae}from"./CqhXhs4g.js";import"./xihTtKlq.js";import{t as k}from"./BzAMLulQ.js";import{t as oe}from"./Ld_qpfDN.js";import{t as se}from"./Cwq8aIcs.js";import{a as A,d as ce,i as j,l as le,n as ue,o as M,r as N,s as P,t as de,u as fe}from"./C49vcxji.js";import{t as pe}from"./DPrxXDHb.js";import{r as me}from"./D2q35Vo6.js";import{i as he,r as F,t as I}from"./BciDxNzc.js";function ge(e,t){let n=[];for(let r of e){let e=((r.activation_path?.length?r.activation_path:r.retrieved)??[]).filter(t);if(e.length===0)continue;let i=e[e.length-1];n.push({targetId:i,pathIds:e})}return n}function _e(e,t=12){return[...e].sort((e,t)=>t.retention-e.retention||e.id.localeCompare(t.id)).slice(0,t).map(e=>({targetId:e.id,pathIds:[e.id]}))}function ve(e,t,n=5){let r=new Map;for(let n of e){let e=(n.activation_path?.length?n.activation_path:n.retrieved)??[];for(let n of new Set(e))t(n)&&r.set(n,(r.get(n)??0)+1)}return[...r.entries()].map(([e,t])=>({id:e,recalls:t})).sort((e,t)=>t.recalls-e.recalls||e.id.localeCompare(t.id)).slice(0,n)}var ye=class{bridge;items=[];cursor=0;ticks=0;nextTick=0;intervalFrames;enabled=!0;started=!1;constructor(e,t={}){this.bridge=e,this.intervalFrames=Math.max(60,t.intervalFrames??240)}setItems(e){this.items=e,this.cursor=0}get itemCount(){return this.items.length}setEnabled(e){this.enabled=e}tick(e){if(!this.enabled||this.items.length===0)return;if(this.ticks++,!this.started){this.started=!0,this.nextTick=this.ticks+45;return}if(this.ticks<this.nextTick)return;if(this.bridge.hasActiveEvent){this.nextTick=this.ticks+90;return}let t=this.items[this.cursor%this.items.length];this.cursor++;let n=this.bridge.replayRecall(t.targetId,t.pathIds,e);this.nextTick=this.ticks+this.intervalFrames+(n?0:30)}},L=s(`<span class="hidden lg:inline text-[#ffffff]/[0.5] whitespace-nowrap"> </span>`),be=s(`<span class="text-[#a6dcff] tracking-widest whitespace-nowrap"> </span>`),xe=s(`<span class="text-[#5dcaa5] whitespace-nowrap w-[6ch] text-right"> </span>`),Se=s(`<div class="absolute top-0 left-0 right-0 z-20 pointer-events-none" style="padding-top: env(safe-area-inset-top);"><div class="flex items-center justify-between gap-3 px-4 py-2 bg-gradient-to-b from-[#05060a]/85 to-transparent font-mono text-xs [font-variant-numeric:tabular-nums]"><div class="flex items-center gap-3 min-w-0 flex-1 overflow-hidden"><span class="text-[#5dcaa5] tracking-widest uppercase truncate"> </span> <span class="hidden md:inline text-[#ffffff]/[0.5] whitespace-nowrap"> </span></div> <div class="hidden sm:flex items-center gap-4"><span class="text-[#ffffff]/[0.55] whitespace-nowrap"> </span> <!></div> <div class="flex items-center gap-3"><span class="text-[#ffffff]/[0.55] whitespace-nowrap"> </span> <!> <button class="text-[#ffffff]/[0.5] hover:text-[#5dcaa5] transition-colors cursor-pointer pointer-events-auto whitespace-nowrap">[url]</button></div></div></div>`);function Ce(e,n){ee(n,!0);let r=_(n,`demoMode`,3,`recall-path`),a=_(n,`seed`,3,`vestige-observatory-v1`),o=_(n,`nodeCount`,3,0),s=_(n,`edgeCount`,3,0),u=_(n,`centerId`,3,``),d=_(n,`frameCount`,3,0),p=_(n,`fpsEstimate`,3,0),g=_(n,`freezeFrame`,3,null);_(n,`loading`,3,!1),_(n,`error`,3,``);function v(){let e=new URLSearchParams({demo:r(),seed:a()});g()!==null&&e.set(`frame`,String(g()));let t=`${window.location.origin}${ae}/observatory?${e.toString()}`;navigator.clipboard.writeText(t).catch(()=>{})}var y=Se(),b=m(y),x=m(b),w=m(x),te=h(w,!0),E=l(w,2),ne=h(E);C(x);var D=l(x,2),re=m(D),O=h(re),oe=l(re,2),se=e=>{var n=L(),r=h(n);f(e=>T(r,`center=${e??``}`),[()=>u().slice(0,8)]),t(e,n)};c(oe,e=>{u()&&e(se)}),C(D);var A=l(D,2),ce=m(A),j=h(ce),le=l(ce,2),ue=e=>{var n=be(),r=h(n,!0);f(e=>T(r,e),[()=>k(`CAPTURE`)]),t(e,n)},M=e=>{var n=xe(),r=h(n);f(()=>T(r,`${p()??``}fps`)),t(e,n)};c(le,e=>{g()===null?p()>0&&e(M,1):e(ue)});var N=l(le,2);C(A),C(b),C(y),f((e,t,n,i,c,l)=>{T(te,r()),T(ne,`seed=${e??``}${a().length>12?`…`:``}`),T(O,`${o()??``} ${t??``} ${s()??``} ${n??``}`),T(j,`${i??``} ${c??``}`),S(N,`title`,l)},[()=>a().slice(0,12),()=>k(`nodes ·`),()=>k(`edges`),()=>k(`frame:`),()=>String(d()).padStart(3,` `),()=>k(`Copy shareable demo URL`)]),i(`click`,N,v),t(e,y),ie()}n([`click`]);var we=s(`<div class="active-label svelte-8n8iia"> </div>`),R=s(`<div></div>`),Te=s(`<div class="spine svelte-8n8iia"><!> <div class="track svelte-8n8iia"><!> <div class="playhead svelte-8n8iia"></div></div></div>`);function Ee(e,n){ee(n,!0);let r=_(n,`steps`,19,()=>[]),i=_(n,`frame`,3,0),a=_(n,`loopFrames`,3,720),o=e=>e/a()*100;function s(e,t){let n=t-e;return n<-14||n>90?0:n<0?1+n/14:1-n/90}let v=E(()=>{let e=``,t=.15;for(let n of r()){let r=s(n.beatFrame,i());r>t&&(t=r,e=n.label)}return e});var y=te(),b=p(y),x=e=>{var n=Te(),a=m(n),p=e=>{var n=we(),r=h(n,!0);f(()=>T(r,u(v))),t(e,n)};c(a,e=>{u(v)&&e(p)});var _=l(a,2),y=m(_);d(y,17,r,e=>e.beatFrame,(e,n)=>{var r=R();let a;f((e,t,i)=>{a=O(r,1,`tick svelte-8n8iia`,null,a,{hot:e,backward:u(n).kind===1}),g(r,`left: ${t??``}%; opacity: ${i??``}`),S(r,`title`,u(n).label)},[()=>s(u(n).beatFrame,i())>0,()=>o(u(n).beatFrame),()=>.45+.55*s(u(n).beatFrame,i())]),t(e,r)});var b=l(y,2);C(_),C(n),f(e=>g(b,`left: ${e??``}%`),[()=>o(i())]),t(e,n)};c(b,e=>{r().length>0&&e(x)}),t(e,y),ie()}var De=s(`<div><div class="k svelte-ssd7yu"> </div> <div class="v svelte-ssd7yu"> </div> <div class="s svelte-ssd7yu"> </div></div>`);function Oe(e,n){ee(n,!0);let r=_(n,`frame`,3,0),i=_(n,`fadeWindow`,19,()=>[600,620,705,719]),a=_(n,`tone`,3,`triumph`),o=(e,t,n)=>{let r=Math.min(1,Math.max(0,(n-e)/(t-e)));return r*r*(3-2*r)},s=E(()=>o(i()[0],i()[1],r())*(1-o(i()[2],i()[3],r())));var d=te(),v=p(d),y=e=>{var r=De();let i;var o=m(r),c=h(o,!0),d=l(o,2),p=h(d,!0),_=l(d,2),v=h(_,!0);C(r),f(()=>{i=O(r,1,`verdict svelte-ssd7yu`,null,i,{quarantine:a()===`quarantine`}),g(r,`opacity: ${u(s)??``}`),T(c,n.verdict.headline),T(p,n.verdict.causeLabel),T(v,n.verdict.receipt)}),t(e,r)};c(v,e=>{u(s)>.001&&e(y)}),t(e,d),ie()}function ke(e,t,n,r){let i=1/Math.tan(e/2),a=1/(n-r),o=new Float32Array(16);return o[0]=i/t,o[5]=i,o[10]=r*a,o[11]=-1,o[14]=r*n*a,o}function Ae(e,t,n){let[r,i,a]=e,o=r-t[0],s=i-t[1],c=a-t[2],l=Math.hypot(o,s,c)||1;o/=l,s/=l,c/=l;let u=n[1]*c-n[2]*s,d=n[2]*o-n[0]*c,f=n[0]*s-n[1]*o;l=Math.hypot(u,d,f)||1,u/=l,d/=l,f/=l;let p=s*f-c*d,m=c*u-o*f,h=o*d-s*u,g=new Float32Array(16);return g[0]=u,g[1]=p,g[2]=o,g[4]=d,g[5]=m,g[6]=s,g[8]=f,g[9]=h,g[10]=c,g[12]=-(u*r+d*i+f*a),g[13]=-(p*r+m*i+h*a),g[14]=-(o*r+s*i+c*a),g[15]=1,g}function z(e,t){let n=new Float32Array(16);for(let r=0;r<4;r++)for(let i=0;i<4;i++)n[r*4+i]=e[i]*t[r*4]+e[4+i]*t[r*4+1]+e[8+i]*t[r*4+2]+e[12+i]*t[r*4+3];return n}function je(e,t,n,r=.35,i=0){let a=e*Math.PI*2+i,o=[Math.sin(a)*n,n*r,Math.cos(a)*n],s=ke(50*Math.PI/180,t,.1,4e3),c=Ae(o,[0,0,0],[0,1,0]),l=-o[0],u=-o[1],d=-o[2],f=Math.hypot(l,u,d)||1;l/=f,u/=f,d/=f;let p=u*0-d*1,m=d*0-l*0,h=l*1-u*0;f=Math.hypot(p,m,h)||1,p/=f,m/=f,h/=f;let g=m*d-h*u,_=h*l-p*d,v=p*u-m*l;return{viewProj:z(s,c),right:[p,m,h],up:[g,_,v],eye:o}}var B={yaw:0,pitch:0,zoom:1},Me=.38,Ne=2.6,Pe=-.18,Fe=.82;function Ie(e,t,n){return Math.min(n,Math.max(t,e))}function Le(e){return{yaw:Number.isFinite(e.yaw)?e.yaw:0,pitch:Ie(Number.isFinite(e.pitch)?e.pitch:0,Pe,Fe),zoom:Ie(Number.isFinite(e.zoom)?e.zoom:1,Me,Ne)}}function Re(e,t,n,r=B){let i=Le(r);return je(e,t,n/i.zoom,.35+i.pitch,i.yaw)}var ze=class{state={...B};dragging=!1;pointerId=null;lastX=0;lastY=0;pinch0=0;pointers=new Map;enabled=!0;reset(){this.state={...B},this.dragging=!1,this.pointerId=null,this.pointers.clear()}onPointerDown(e){this.enabled&&e.button===0&&(this.pointers.set(e.pointerId,{x:e.clientX,y:e.clientY}),this.pointers.size===1?(this.dragging=!0,this.pointerId=e.pointerId,this.lastX=e.clientX,this.lastY=e.clientY,e.currentTarget?.setPointerCapture?.(e.pointerId)):this.pointers.size===2&&(this.pinch0=Be(this.pointers)))}onPointerMove(e){if(!this.enabled)return!1;if(this.pointers.has(e.pointerId)&&this.pointers.set(e.pointerId,{x:e.clientX,y:e.clientY}),this.pointers.size===2&&this.pinch0>0){let e=Be(this.pointers),t=e/this.pinch0;return this.state=Le({...this.state,zoom:this.state.zoom*Ie(t,.94,1.06)}),this.pinch0=e,!0}if(!this.dragging||e.pointerId!==this.pointerId)return!1;let t=e.clientX-this.lastX,n=e.clientY-this.lastY;return this.lastX=e.clientX,this.lastY=e.clientY,this.state=Le({yaw:this.state.yaw-t*.005,pitch:this.state.pitch+n*.003,zoom:this.state.zoom}),!0}onPointerUp(e){this.pointers.delete(e.pointerId),e.pointerId===this.pointerId&&(this.dragging=!1,this.pointerId=null),this.pointers.size<2&&(this.pinch0=0)}onWheel(e){if(!this.enabled)return!1;e.preventDefault();let t=e.deltaY>0?.92:1.08;return this.state=Le({...this.state,zoom:this.state.zoom*t}),!0}};function Be(e){let t=[...e.values()];return t.length<2?0:Math.hypot(t[0].x-t[1].x,t[0].y-t[1].y)}function Ve(e){let t=/^#?([0-9a-fA-F]{6})$/.exec(e.trim());if(!t)return[107/255,114/255,128/255];let n=parseInt(t[1],16);return[(n>>16&255)/255,(n>>8&255)/255,(n&255)/255]}function V(e){return Ve(F({tags:e.tags})||I[he(e.retention)])}function He(e){let t=[...e.nodes].sort((e,t)=>e.isCenter===t.isCenter?e.id<t.id?-1:+(e.id>t.id):e.isCenter?-1:1).map((e,t)=>le(e,t)),n=new Map;for(let e of t)n.set(e.id,e.index);let r=[];for(let t of e.edges){let e=n.get(t.source),i=n.get(t.target);e!==void 0&&i!==void 0&&e!==i&&r.push({sourceIndex:e,targetIndex:i,weight:t.weight,type:t.type})}let i=t.findIndex(e=>e.isCenter);return{nodes:t,edges:r,indexById:n,centerIndex:i<0?0:i}}function Ue(e,t,n=120){let r=e.nodes.length,i=new Float32Array(r*16);for(let a=0;a<r;a++){let o=e.nodes[a],s=a*16,[c,l,u]=o.isCenter&&e.centerIndex===a?[0,0,0]:ce(a,r,n,t),d=o.isCenter?4.2:1.4+o.retention*1.8;i[s+A.posRadius+0]=c,i[s+A.posRadius+1]=l,i[s+A.posRadius+2]=u,i[s+A.posRadius+3]=d,i[s+A.velRetention+3]=o.retention;let[f,p,m]=V(o),h=0;o.isCenter&&(h|=j.isCenter),o.suppressed&&(h|=j.suppressed);let g=new Set(o.tags.map(e=>e.toLowerCase()));g.has(`aha`)&&(h|=j.isAha),(g.has(`failure`)||g.has(`guardrail`))&&(h|=j.isFailure),(g.has(`confusion`)||g.has(`weak-spot`))&&(h|=j.isConfusion),i[s+A.colorFlags+0]=f,i[s+A.colorFlags+1]=p,i[s+A.colorFlags+2]=m,i[s+A.colorFlags+3]=h}return{data:i,nodeCount:r}}function We(e){let t=new Uint32Array(Math.max(1,e.edges.length)*2);return e.edges.forEach((e,n)=>{t[n*2]=e.sourceIndex,t[n*2+1]=e.targetIndex}),t}var Ge=`
struct Params {
	frame: f32,
	loop_phase: f32,
	node_count: f32,
...
`;function En(e,t){return Number.isFinite(e)?e:t}var Dn=class{engine;renderer;sourceIndices;resources=null;projectionPipeline=null;seedPipeline=null;transportPipeline=null;compositePipeline=null;projectionLayout=null;seedLayout=null;transportLayout=null;compositeLayout=null;emitterCount;active=!1;dirty=!0;lastComputedFrame=-5;disposed=!1;disabledReason=null;exposure=.42;configBytes=new ArrayBuffer($);configUints=new Uint32Array(this.configBytes);configFloats=new Float32Array(this.configBytes);constructor(e,t,n){this.engine=e,this.renderer=t;let r=[...new Set([...n].filter(e=>Number.isFinite(e)&&e>=0))].sort((e,t)=>e-t).slice(0,yn);this.sourceIndices=new Uint32Array(r),this.emitterCount=this.sourceIndices.length}get quality(){return this.disabledReason===null?`half-res-transport`:`disabled`}get fallbackReason(){return this.disabledReason}setScrubbing(e){this.active=e,this.dirty=!0,this.engine.requestRender()}setExposure(e){this.exposure=Math.max(0,Math.min(.72,En(e,.42))),this.dirty=!0,this.engine.requestRender()}targetFrameRate(){return this.active?60:10}compute(e,t=0){if(this.disposed||this.disabledReason!==null||this.emitterCount===0)return;let n=this.engine.gpuDevice;if(!n||!this.engine.paramsBuffer)return;let r=this.renderer.getFossilLightSources();if(!r)return;let i=this.fieldDimensions();if(i===null)return;let a=t-this.lastComputedFrame;if(!(this.active||this.dirty||a<0||a>=wn))return;try{this.ensurePipelines(n),this.ensureResources(n,i.width,i.height,r)}catch{this.disable(`GPU light field unavailable on this adapter`);return}if(!this.resources||!this.projectionPipeline||!this.seedPipeline||!this.transportPipeline)return;this.writeConfig(n,0,this.resources.width,this.resources.height,0);let o=Math.ceil(this.resources.width/8),s=Math.ceil(this.resources.height/8),c=e.beginComputePass({label:`fossil-light-half-res-transport`});c.setPipeline(this.projectionPipeline),c.setBindGroup(3,this.resources.projectionBindGroup,[0]),c.dispatchWorkgroups(Math.ceil(this.emitterCount/64)),c.setPipeline(this.seedPipeline),c.setBindGroup(0,this.resources.seedBindGroup,[0]),c.dispatchWorkgroups(o,s);for(let[e,t,r]of[[1,4,this.resources.propagateABindGroup],[2,13,this.resources.propagateBBindGroup],[3,37,this.resources.propagateABindGroup]])this.writeConfig(n,e,this.resources.width,this.resources.height,t),c.setPipeline(this.transportPipeline),c.setBindGroup(1,r,[e*xn]),c.dispatchWorkgroups(o,s);c.end(),this.dirty=!1,this.lastComputedFrame=t}render(e){this.disabledReason===null&&this.resources&&this.compositePipeline&&this.emitterCount!==0&&(e.setPipeline(this.compositePipeline),e.setBindGroup(2,this.resources.compositeBindGroup,[3*xn]),e.draw(6))}dispose(){this.disposed||(this.disposed=!0,this.destroyResources(),this.projectionPipeline=null,this.seedPipeline=null,this.transportPipeline=null,this.compositePipeline=null,this.seedLayout=null,this.projectionLayout=null,this.transportLayout=null,this.compositeLayout=null)}fieldDimensions(){let e=Math.floor(this.engine.params[6]),t=Math.floor(this.engine.params[7]);if(e<2||t<2)return null;let n=e*.5*(t*.5),r=.5*Math.min(1,Math.sqrt(Cn/Math.max(1,n)));return{width:Math.max(1,Math.floor(e*r)),height:Math.max(1,Math.floor(t*r))}}ensurePipelines(e){if(this.projectionPipeline&&this.seedPipeline&&this.transportPipeline&&this.compositePipeline)return;let t=e.createShaderModule({label:`fossil-light-radiance-cascade-wgsl`,code:Tn}),n=e.createBindGroupLayout({label:`fossil-light-empty-layout`,entries:[]});this.projectionLayout=e.createBindGroupLayout({label:`fossil-light-source-projection-layout`,entries:[{binding:0,visibility:GPUShaderStage.COMPUTE,buffer:{type:`uniform`,hasDynamicOffset:!0,minBindingSize:$}},{binding:1,visibility:GPUShaderStage.COMPUTE,buffer:{type:`read-only-storage`}},{binding:2,visibility:GPUShaderStage.COMPUTE,buffer:{type:`read-only-storage`}},{binding:3,visibility:GPUShaderStage.COMPUTE,buffer:{type:`uniform`}},{binding:4,visibility:GPUShaderStage.COMPUTE,buffer:{type:`storage`}}]}),this.seedLayout=e.createBindGroupLayout({label:`fossil-light-seed-layout`,entries:[{binding:0,visibility:GPUShaderStage.COMPUTE,buffer:{type:`uniform`,hasDynamicOffset:!0,minBindingSize:$}},{binding:1,visibility:GPUShaderStage.COMPUTE,buffer:{type:`read-only-storage`}},{binding:2,visibility:GPUShaderStage.COMPUTE,storageTexture:{access:`write-only`,format:Sn}}]}),this.transportLayout=e.createBindGroupLayout({label:`fossil-light-transport-layout`,entries:[{binding:0,visibility:GPUShaderStage.COMPUTE,buffer:{type:`uniform`,hasDynamicOffset:!0,minBindingSize:$}},{binding:1,visibility:GPUShaderStage.COMPUTE,texture:{sampleType:`float`,viewDimension:`2d`}},{binding:2,visibility:GPUShaderStage.COMPUTE,storageTexture:{access:`write-only`,format:Sn}}]}),this.compositeLayout=e.createBindGroupLayout({label:`fossil-light-composite-layout`,entries:[{binding:0,visibility:GPUShaderStage.FRAGMENT,buffer:{type:`uniform`,hasDynamicOffset:!0,minBindingSize:$}},{binding:1,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:`float`,viewDimension:`2d`}}]}),this.seedPipeline=e.createComputePipeline({label:`fossil-light-seed`,layout:e.createPipelineLayout({label:`fossil-light-seed-pipeline-layout`,bindGroupLayouts:[this.seedLayout]}),compute:{module:t,entryPoint:`cs_seed`}}),this.projectionPipeline=e.createComputePipeline({label:`fossil-light-source-projection`,layout:e.createPipelineLayout({label:`fossil-light-source-projection-pipeline-layout`,bindGroupLayouts:[n,n,n,this.projectionLayout]}),compute:{module:t,entryPoint:`cs_project_sources`}}),this.transportPipeline=e.createComputePipeline({label:`fossil-light-transport`,layout:e.createPipelineLayout({label:`fossil-light-transport-pipeline-layout`,bindGroupLayouts:[n,this.transportLayout]}),compute:{module:t,entryPoint:`cs_transport`}}),this.compositePipeline=e.createRenderPipeline({label:`fossil-light-composite`,layout:e.createPipelineLayout({label:`fossil-light-composite-pipeline-layout`,bindGroupLayouts:[n,n,this.compositeLayout]}),vertex:{module:t,entryPoint:`vs_composite`},fragment:{module:t,entryPoint:`fs_composite`,targets:[{format:this.engine.sceneFormat,blend:{color:{srcFactor:`src-alpha`,dstFactor:`one`,operation:`add`},alpha:{srcFactor:`one`,dstFactor:`one`,operation:`add`}}}]}})}ensureResources(e,t,n,r){if(this.resources?.width===t&&this.resources.height===n&&this.resources.nodeBuffer===r.nodeBuffer&&this.resources.cameraBuffer===r.cameraBuffer||(this.destroyResources(),!this.projectionLayout||!this.seedLayout||!this.transportLayout||!this.compositeLayout))return;let i=e.createBuffer({label:`fossil-light-projected-memory-emitters`,size:768*Float32Array.BYTES_PER_ELEMENT,usage:GPUBufferUsage.STORAGE}),a=e.createBuffer({label:`fossil-light-source-indices`,size:Math.max(4,this.sourceIndices.byteLength),usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST});e.queue.writeBuffer(a,0,this.sourceIndices.buffer,this.sourceIndices.byteOffset,this.sourceIndices.byteLength);let o=e.createBuffer({label:`fossil-light-cascade-config`,size:xn*bn,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),s=r=>e.createTexture({label:r,size:[t,n],format:Sn,usage:GPUTextureUsage.TEXTURE_BINDING|GPUTextureUsage.STORAGE_BINDING}),c=s(`fossil-light-field-a`),l=s(`fossil-light-field-b`),u=c.createView(),d=l.createView();this.resources={width:t,height:n,emitterBuffer:i,sourceIndexBuffer:a,configBuffer:o,fieldA:c,fieldB:l,seedBindGroup:e.createBindGroup({label:`fossil-light-seed-bind-group`,layout:this.seedLayout,entries:[{binding:0,resource:{buffer:o,size:$}},{binding:1,resource:{buffer:i}},{binding:2,resource:u}]}),propagateABindGroup:e.createBindGroup({label:`fossil-light-transport-a-to-b`,layout:this.transportLayout,entries:[{binding:0,resource:{buffer:o,size:$}},{binding:1,resource:u},{binding:2,resource:d}]}),propagateBBindGroup:e.createBindGroup({label:`fossil-light-transport-b-to-a`,layout:this.transportLayout,entries:[{binding:0,resource:{buffer:o,size:$}},{binding:1,resource:d},{binding:2,resource:u}]}),projectionBindGroup:e.createBindGroup({label:`fossil-light-source-projection-bind-group`,layout:this.projectionLayout,entries:[{binding:0,resource:{buffer:o,size:$}},{binding:1,resource:{buffer:a}},{binding:2,resource:{buffer:r.nodeBuffer}},{binding:3,resource:{buffer:r.cameraBuffer}},{binding:4,resource:{buffer:i}}]}),compositeBindGroup:e.createBindGroup({label:`fossil-light-composite-bind-group`,layout:this.compositeLayout,entries:[{binding:0,resource:{buffer:o,size:$}},{binding:1,resource:d}]}),nodeBuffer:r.nodeBuffer,cameraBuffer:r.cameraBuffer},this.dirty=!0}writeConfig(e,t,n,r,i){this.resources&&(this.configUints[0]=n,this.configUints[1]=r,this.configUints[2]=this.emitterCount,this.configUints[3]=i,this.configFloats[4]=this.exposure,this.configFloats[5]=1,e.queue.writeBuffer(this.resources.configBuffer,t*xn,this.configBytes))}destroyResources(){this.resources?.emitterBuffer.destroy(),this.resources?.sourceIndexBuffer.destroy(),this.resources?.configBuffer.destroy(),this.resources?.fieldA.destroy(),this.resources?.fieldB.destroy(),this.resources=null}disable(e){this.destroyResources(),this.disabledReason=e,this.engine.requestRender()}},On=s(`<div class="flex items-baseline gap-2 font-mono text-[11px]"><span class="text-[#E9FFB7]/90 tabular-nums w-4"> </span> <span class="text-[#d8ded0]/90 truncate flex-1"> </span> <span class="text-[#A8FF5E]/80 tabular-nums whitespace-nowrap"> </span></div>`),kn=s(`<div class="absolute top-20 right-4 sm:right-6 max-w-[15rem] flex flex-col gap-1.5
					...
					hover:border-[#22C7DE]/50 transition-colors"> </button>`),Mn=s(`<button class="text-[#d8ded0]/55 hover:text-[#d8ded0] transition-colors"> </button>`),Nn=s(`<div><span class="text-[#91ad8a]/80 uppercase whitespace-nowrap"> </span> <input type="range" max="365" step="0.25" class="w-36 sm:w-52 accent-[#91ad8a] cursor-ew-resize opacity-75 hover:opacity-100 transition-opacity"/> <span> </span> <!></div>`),Pn=s(`<button class="absolute top-10 right-4 pointer-events-auto font-mono text-xs tracking-widest
					text-[#5dcaa5]/70 hover:text-[#5dcaa5] border border-[#5dcaa5]/25 hover:border-[#5dcaa5]/60
					bg-[#05060a]/70 rounded px-3 py-1.5 transition-colors"> </button>`),Fn=s(`<button> </button>`),In=s(`<div class="absolute top-10 left-4 pointer-events-auto flex flex-col gap-1.5"></div>`),Ln=s(`<div class="absolute inset-0 flex items-center justify-center pointer-events-auto"><div class="text-[#5dcaa5] font-mono text-sm tracking-widest animate-pulse"> </div></div>`),Rn=s(`<div class="absolute inset-0 flex items-center justify-center pointer-events-auto"><div class="text-red-400 font-mono text-sm border border-red-900/50 bg-red-950/30 px-4 py-2 rounded"> </div></div>`),zn=s(`<div class="absolute inset-0 flex items-center justify-center pointer-events-auto"><div class="text-[#5dcaa5] font-mono text-sm tracking-widest"> </div></div>`),Bn=s(`<div class="absolute inset-0 z-10 pointer-events-none"><!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!></div>`),Vn=s(`<div class="pointer-events-none fixed left-4 bottom-24 z-30 font-mono text-[10px] tracking-widest text-[#7ff3e6]/80"> </div>`),Hn=s(`<div><div role="application"><!></div> <!></div> <!> <!>`,1);function Un(n,s){ee(s,!0);let g=()=>v(oe,`$eventFeed`,te),[te,ae]=w(),A=_(s,`seed`,3,`vestige-observatory-v1`),ce=_(s,`freezeFrame`,3,null),j=_(s,`capture`,3,!1),le=_(s,`showSwitcher`,3,!0),M=_(s,`embedded`,3,!1),N=_(s,`chrome`,3,`none`),P=_(s,`maxDpr`,3,2),fe=_(s,`focusIds`,19,()=>[]),me=_(s,`live`,3,!1),he=_(s,`graphOverride`,3,null),F=D(0),I=D(!1),L=D(0),be=null,xe=E(()=>Math.max(0,u(F))),Se=E(()=>Math.min(0,u(F))),we=E(()=>u(F)===0?`now`:u(F)>0?`+${Math.round(u(F))}d`:new Date(Date.now()+u(F)*864e5).toLocaleDateString(`zh-CN`,{month:`short`,day:`numeric`})),R=null,Te=null,De=null,ke=D(!1),Ae=D(!1),z=!1,je=0,B=0,Me=0,Ne=!1;function Pe(e){let t=u(H)?.getBoundingClientRect();if(!t||t.width===0)return u(F);let n=(e-t.left)/t.width*2-1,r=Math.max(0,Math.min(1,n/.835*.5+.5));return u(L)+r*(365-u(L))}function Fe(e){let t=u(H)?.getBoundingClientRect();if(!t||t.height===0)return!1;let n=(e.clientY-t.top)/t.height;return n>.7675000000000001&&n<.9175}function Ie(){je&&cancelAnimationFrame(je),je=0}function Le(e){u(ke)&&!j()&&Fe(e)&&(Ie(),z=!0,x(I,!0),B=0,Me=performance.now(),x(F,Pe(e.clientX),!0),e.currentTarget.setPointerCapture?.(e.pointerId),e.preventDefault())}function Re(e){if(!z)return;let t=performance.now(),n=Pe(e.clientX),r=Math.max(1,t-Me);B=B*.6+(n-u(F))/r*16*.4,Me=t,x(F,n,!0)}function Be(e){if(!z)return;z=!1,Ne=!0,e.currentTarget.releasePointerCapture?.(e.pointerId);let t=()=>{je=0,B*=.94;let e=u(F)+B;e<=u(L)&&(e=u(L),B=0),e>=365&&(e=365,B=0);let n=u(F)<0&&B>0||u(F)>0&&B<0;Math.abs(e)<1&&n&&(e=0,B=0),x(F,e,!0),Math.abs(B)>.02?je=requestAnimationFrame(t):x(I,!1)};Math.abs(B)>.05?je=requestAnimationFrame(t):x(I,!1)}function Ve(){z=!1,x(I,!1),Ie()}let V=D(!1),He=D(!1);function Ue(){if(typeof window>`u`)return;let e=window.matchMedia(`(prefers-reduced-motion: reduce)`);e.matches&&!u(He)&&x(V,!0);let t=e=>{u(He)||x(V,e.matches,!0)};return e.addEventListener(`change`,t),()=>e.removeEventListener(`change`,t)}function We(){x(He,!0),x(V,!u(V))}r(()=>{u(K)?.setPaused(u(V))});let Ge=D(``),Ke=D(0),qe=E(()=>u(Ge)!==``&&u(Ke)>0),H=D(null),U=new ze,Je=D(null),Ye=0,Xe=D(``);async function W(e){if(Ne){Ne=!1;return}if(!q||!u(H))return;let t=u(H).getBoundingClientRect();if(t.width===0||t.height===0)return;let n=(e.clientX-t.left)/t.width*2-1,r=-((e.clientY-t.top)/t.height*2-1),i=await q.pickAt(n,r);i&&(x(Je,{kind:`memory`,id:i.id,label:k(`Field cell`)},!0),s.onpick?.(i.id))}function Qe(e){Le(e),!(z||j())&&(U.enabled=!j(),U.onPointerDown(e))}function $e(e){if(Re(e),z||j())return;U.onPointerMove(e)&&(Ne=!0,q?.setCameraRig(U.state));let t=performance.now();if(t-Ye<120||!q||!u(H))return;Ye=t;let n=u(H).getBoundingClientRect();if(n.width===0)return;let r=(e.clientX-n.left)/n.width*2-1,i=-((e.clientY-n.top)/n.height*2-1);q.pickAt(r,i).then(e=>{q?.setHovered(e?.index??-1),x(Xe,e?.id?.slice(0,8)??``,!0),u(H)&&(u(H).style.cursor=e?`crosshair`:`grab`)})}function et(e){Be(e),U.onPointerUp(e)}function tt(){Ve(),U.onPointerUp({pointerId:-1})}function nt(e){j()||Fe(e)||U.onWheel(e)&&q?.setCameraRig(U.state)}let rt={"recall-path":`RECALL`,"engram-birth":`BIRTH`,"salience-rescue":`RESCUE`,"forgetting-horizon":`HORIZON`,firewall:`FIREWALL`};function it(){return q?.graph?new Uint32Array(q.graph.nodes.map(e=>({index:e.index,id:e.id,retention:e.retention})).sort((e,t)=>t.retention-e.retention||e.id.localeCompare(t.id)).slice(0,64).map(e=>e.index).sort((e,t)=>e-t)):new Uint32Array}let at=D(!j());function ot(e){let t=e.target;t?.isContentEditable||t?.tagName===`INPUT`||t?.tagName===`TEXTAREA`||t?.tagName===`SELECT`||((e.key===`h`||e.key===`H`)&&x(at,!u(at)),e.key===`Escape`&&s.onexit&&s.onexit(),(e.key===` `||e.key.toLowerCase()===`p`)&&!j()&&(e.preventDefault(),We()))}let G=D(null),st=D(!0),ct=D(``),lt=D(0),ut=D(0),dt=D(0),ft=D(0),pt=D(``),K=D(null),q=null,ht=null,_t=null,vt=D(null),yt=null,bt=null,xt=D(null),St=!1,Ct=D(e([]));async function wt(){x(st,!0),x(ct,``);try{if(he()){x(G,he()),x(dt,he().nodeCount,!0),x(ft,he().edgeCount,!0),x(pt,he().center_id,!0);return}let e=new Set(fe().filter(Boolean)),t=e.size?await(async()=>{let t=await Promise.all([...e].map(e=>se.graph({center_id:e,max_nodes:200,depth:3}))),n=[...new Map(t.flatMap(e=>e.nodes).map(e=>[e.id,e])).values()].filter(t=>e.has(t.id)),r=new Set(n.map(e=>e.id)),i=[...new Map(t.flatMap(e=>e.edges).map(e=>[`${e.source}:${e.target}`,e])).values()].filter(e=>r.has(e.source)&&r.has(e.target));return{...t[0],nodes:n,edges:i,center_id:n[0]?.id??t[0]?.center_id??``,nodeCount:n.length,edgeCount:i.length}})():await se.graph({max_nodes:200,depth:3,sort:`connected`});x(G,t,!0),x(dt,t.nodeCount,!0),x(ft,t.edgeCount,!0),x(pt,t.center_id,!0)}catch(e){let t=e instanceof Error?e.message:k(`Failed to load graph data`);/\b404\b/.test(t)?(x(G,{nodes:[],edges:[],nodeCount:0,edgeCount:0,center_id:``},!0),x(dt,0),x(ft,0),x(pt,``)):x(ct,t,!0)}finally{x(st,!1)}}let J=null,Tt=D(e([])),Et=D(`recalls`);function Y(e,t){x(lt,e,!0),x(ut,t,!0),J&&!u(I)&&J.tick(e)}async function X(){if(!R||!q?.graph)return;let e=q.graph,t=t=>e.indexById.has(t),n=t=>e.nodes[e.indexById.get(t)??-1]?.label??t.slice(0,8),r=[];try{r=(await se.receipts.list(60))?.receipts??[]}catch{}let i=ge(r,t);i.length===0&&(i=_e(e.nodes,12)),i.length>0&&(J=new ye(R,{intervalFrames:240}),J.setItems(i));let a=ve(r,t,3);a.length>0?(x(Et,`recalls`),x(Tt,a.map(e=>({...e,label:n(e.id)})),!0)):(x(Et,`retention`),x(Tt,[...e.nodes].filter(e=>(e.label??``).trim().length>0).sort((e,t)=>t.retention-e.retention).slice(0,3).map(e=>({id:e.id,recalls:Math.round(e.retention*100),label:e.label||e.id.slice(0,8)})),!0))}function Z(e){St=!1,q?.dispose(),x(K,e,!0),q=new Ze(e),U.enabled=!j(),j()&&U.reset(),q.setCameraRig(U.state),s.onready?.(e)}r(()=>{if(u(K)&&q&&u(G)&&!St){St=!0;let e=s.demo===`engram-birth`,t=s.demo===`salience-rescue`,n=s.demo===`forgetting-horizon`,r=s.demo===`firewall`;if(q.upload(u(G),A(),{recallPath:!e&&!t&&!n&&!r}),e){ht=new mt({engine:u(K),nodeRenderer:q,seed:A()}),ht.upload(A());let e=ht.engraveSteps,t=[];for(let n=0;n<e.length/4;n++)t.push({sourceIndex:e[n*4],targetIndex:e[n*4+1],beatFrame:e[n*4+2],kind:e[n*4+3],beatKind:`engrave`,nodeId:`engrave-${n}`,label:k(`edge engraved`)});q.setPathSteps(e,t),x(Ct,ht.timeline.map((e,t)=>({sourceIndex:0,targetIndex:0,beatFrame:e.startFrame,kind:0,beatKind:`birth`,nodeId:`birth-${t}`,label:e.label})),!0)}else if(t){let e=Dt(u(G),q.graph,A(),s.backfillEvidence);x(vt,e,!0),e.viable&&(_t=new gt({engine:u(K),nodeRenderer:q,plan:e}),_t.upload(),q.setPathSteps(e.pathData,e.pathMetas)),x(Ct,e.spineBeats,!0)}else if(n){let e=It(q.graph);e.viable&&(yt=new jt({engine:u(K),nodeRenderer:q,plan:e}),yt.upload(),q.setPathSteps(e.pathData,e.pathMetas)),x(Ct,e.spineBeats,!0)}else if(r){let e=Jt(q.graph,A());x(xt,e,!0),e.viable&&(bt=new zt({engine:u(K),nodeRenderer:q,plan:e}),bt.upload(),q.setPathSteps(e.pathData,e.pathMetas)),x(Ct,e.spineBeats,!0)}else x(Ct,q.pathSteps,!0);if(me()&&q.graph&&u(G)){R=new on({engine:u(K),renderer:q,graph:q.graph,response:u(G),seed:A(),projectionDays:()=>u(xe),chronoOffsetDays:()=>u(Se),onFirewall:e=>{x(Ge,e.intruderLabel,!0),x(Ke,Date.now(),!0)}}),x(Ae,R.liveDecayAvailable,!0),u(K).setPreFrameHook(e=>R?.drain(e)),j()||X();let e=1/0;for(let t of q.graph.nodes)if(t.createdAt){let n=Date.parse(t.createdAt);Number.isFinite(n)&&n<e&&(e=n)}if(Number.isFinite(e)&&x(L,Math.floor((e-Date.now())/864e5)-1),be){let e=Date.parse(be);Number.isFinite(e)&&x(F,Math.min(365,Math.max(u(L),(e-Date.now())/864e5)),!0),be=null}j()||(De=new Dn(u(K),q,it()),u(K).addPass(De),Te=new vn(u(K),q.graph.nodes),u(K).addPass(Te),x(ke,!0)),typeof window<`u`&&(window.__vestigeLiveBridge=R)}u(K).demoClock.reset()}}),r(()=>{let e=g();R&&R.ingest(e)}),r(()=>{u(F),R?.refreshDecay(),Te?.setTimeline(u(F),u(I)),De?.setScrubbing(u(I))}),r(()=>{if(!u(Ke))return;let e=setTimeout(()=>{x(Ge,``),x(Ke,0)},7e3);return()=>clearTimeout(e)}),ne(()=>{be=new URLSearchParams(window.location.search).get(`t`),wt();let e=Ue();return()=>{if(Ie(),e?.(),q?.dispose(),q=null,typeof window<`u`){let e=window;e.__vestigeLiveBridge===R&&delete e.__vestigeLiveBridge}}});var Ot=Hn();o(`keydown`,a,ot);var kt=p(Ot);let At;var Q=m(kt);let Mt;var Nt=m(Q);de(Nt,{get demo(){return s.demo},get seed(){return A()},get freezeFrame(){return ce()},get maxDpr(){return P()},onframe:Y,onready:Z}),C(Q),y(Q,e=>x(H,e),()=>u(H));var Pt=l(Q,2),Ft=e=>{var n=Bn(),r=m(n),a=e=>{var n=kn(),r=m(n),i=h(r,!0),a=l(r,2);d(a,19,()=>u(Tt),e=>e.id,(e,n,r)=>{var i=On(),a=m(i),o=h(a,!0),s=l(a,2),c=h(s,!0),d=l(s,2),p=h(d);C(i),f(()=>{T(o,u(r)+1),S(s,`title`,u(n).label),T(c,u(n).label),T(p,`${u(n).recalls??``}${u(Et)===`recalls`?`×`:`%`}`)}),t(e,i)}),C(n),f(e=>T(i,e),[()=>u(Et)===`recalls`?k(`Most recalled · your mind`):k(`Strongest memories · your mind`)]),t(e,n)};c(r,e=>{me()&&u(Tt).length>0&&e(a)});var p=l(r,2),g=e=>{var n=An(),r=m(n),i=h(r,!0),a=l(r,2),o=h(a,!0),s=l(a,2),c=h(s,!0);C(n),f((e,t)=>{T(i,e),T(o,u(Ge)),T(c,t)},[()=>k(`⬤ threat quarantined`),()=>k(`memory held in review · Memory PR opened`)]),t(e,n)};c(p,e=>{me()&&u(qe)&&e(g)});var _=l(p,2),v=e=>{var n=jn(),r=h(n,!0);f((e,t,i)=>{S(n,`title`,e),S(n,`aria-pressed`,u(V)),S(n,`aria-label`,t),T(r,i)},[()=>u(V)?k(`Resume field motion`):k(`Pause field motion`),()=>u(V)?k(`Resume 3D memory field motion`):k(`Pause 3D memory field motion`),()=>u(V)?k(`▶ RESUME`):k(`❚❚ PAUSE`)]),i(`click`,n,We),t(e,n)};c(_,e=>{j()||e(v)});var y=l(_,2),ee=e=>{var n=Nn();let r;var a=m(n),s=h(a,!0),d=l(a,2);b(d);var p=l(d,2);let g;var _=h(p,!0),v=l(p,2),y=e=>{var n=Mn(),r=h(n,!0);f((e,t)=>{S(n,`title`,e),T(r,t)},[()=>k(`Return to now`),()=>k(`now`)]),i(`click`,n,()=>x(F,0)),t(e,n)};c(v,e=>{u(F)!==0&&e(y)}),C(n),f((e,t,i)=>{r=O(n,1,`absolute bottom-3 left-1/2 -translate-x-1/2 pointer-events-auto
					flex items-center gap-3 px-3 py-1.5 rounded-full border border-[#91ad8a]/20
					bg-[#05060a]/45 backdrop-blur-[2px] font-mono text-[10px] tracking-[0.14em]`,null,r,{"opacity-100":u(ke),"opacity-75":!u(ke)}),T(s,e),S(d,`min`,u(L)),S(d,`aria-label`,t),S(d,`title`,i),g=O(p,1,`w-16 text-right tabular-nums`,null,g,{"text-[#b9d9a9]":u(F)>=0,"text-[#dfc68e]":u(F)<0}),T(_,u(we))},[()=>k(`Chrono`),()=>k(`Scrub the memory field through time — back to the oldest memory, forward on the forgetting curve`),()=>k(`Rewind the whole brain to any instant, or project it forward — every memory relit on its real FSRS curve`)]),i(`input`,d,()=>x(I,!0)),i(`change`,d,()=>x(I,!1)),i(`pointerup`,d,()=>x(I,!1)),o(`pointercancel`,d,()=>x(I,!1)),o(`blur`,d,()=>x(I,!1)),re(d,()=>u(F),e=>x(F,e)),t(e,n)};c(y,e=>{me()&&u(Ae)&&e(ee)});var w=l(y,2),te=e=>{Ce(e,{get demoMode(){return s.demo},get seed(){return A()},get nodeCount(){return u(dt)},get edgeCount(){return u(ft)},get centerId(){return u(pt)},get frameCount(){return u(lt)},get fpsEstimate(){return u(ut)},get freezeFrame(){return ce()},get loading(){return u(st)},get error(){return u(ct)}})};c(w,e=>{N()===`full`&&e(te)});var ne=l(w,2),D=e=>{var n=Pn(),r=h(n,!0);f((e,t)=>{S(n,`title`,e),T(r,t)},[()=>k(`Exit Observatory (Esc)`),()=>k(`× EXIT`)]),i(`click`,n,function(...e){s.onexit?.apply(this,e)}),t(e,n)};c(ne,e=>{N()===`full`&&s.onexit&&e(D)});var ie=l(ne,2),ae=e=>{var n=In();d(n,20,()=>ue,e=>e,(e,n)=>{var r=Fn(),a=h(r,!0);f(()=>{O(r,1,`font-mono text-[11px] tracking-widest text-left rounded px-3 py-1.5 border transition-colors
							${n===s.demo?`text-[#05060a] bg-[#5dcaa5] border-[#5dcaa5]`:`text-[#5dcaa5]/60 hover:text-[#5dcaa5] bg-[#05060a]/70 border-[#5dcaa5]/20 hover:border-[#5dcaa5]/50`}`),S(r,`title`,`Play the ${rt[n]??``} moment`),T(a,rt[n])}),i(`click`,r,()=>s.ondemochange?.(n)),t(e,r)}),C(n),t(e,n)};c(ie,e=>{N()===`full`&&le()&&e(ae)});var oe=l(ie,2),se=e=>{var n=Ln(),r=m(n),i=h(r,!0);C(n),f(e=>T(i,e),[()=>k(`LOADING MEMORY FIELD...`)]),t(e,n)};c(oe,e=>{u(st)&&e(se)});var M=l(oe,2),P=e=>{var n=Rn(),r=m(n),i=h(r,!0);C(n),f(()=>T(i,u(ct))),t(e,n)};c(M,e=>{u(ct)&&!u(st)&&e(P)});var de=l(M,2),fe=e=>{Ee(e,{get steps(){return u(Ct)},get frame(){return u(lt)}})};c(de,e=>{N()===`full`&&e(fe)});var pe=l(de,2),he=e=>{Oe(e,{get frame(){return u(lt)},get verdict(){return u(vt).verdict}})};c(pe,e=>{N()===`full`&&s.demo===`salience-rescue`&&u(vt)?.viable&&e(he)});var ge=l(pe,2),_e=e=>{{let t=E(()=>({headline:u(xt).verdict.headline,causeLabel:u(xt).verdict.intruderLabel,receipt:u(xt).verdict.receipt}));Oe(e,{get frame(){return u(lt)},tone:`quarantine`,fadeWindow:[480,495,605,620],get verdict(){return u(t)}})}};c(ge,e=>{N()===`full`&&s.demo===`firewall`&&u(xt)?.viable&&e(_e)});var ve=l(ge,2),ye=e=>{var n=zn(),r=m(n),i=h(r,!0);C(n),f(e=>T(i,e),[()=>k(`NO MEMORIES IN FIELD`)]),t(e,n)};c(ve,e=>{!u(st)&&u(G)&&u(G).nodeCount===0&&e(ye)}),C(n),t(e,n)};c(Pt,e=>{u(at)&&e(Ft)}),C(kt);var Lt=l(kt,2);pe(Lt,{get pick(){return u(Je)},onclose:()=>x(Je,null)});var Rt=l(Lt,2),Bt=e=>{var n=Vn(),r=h(n);f(e=>T(r,`${e??``} ${u(Xe)??``}`),[()=>k(`HOVER`)]),t(e,n)};c(Rt,e=>{u(Xe)&&!j()&&e(Bt)}),f(e=>{At=O(kt,1,`${M()?`absolute`:`fixed`} inset-0 overflow-hidden bg-[#05060a]`,null,At,{"cursor-none":j()}),Mt=O(Q,1,`absolute inset-0 z-0 touch-none`,null,Mt,{"cursor-crosshair":!!s.onpick&&!j()}),S(Q,`aria-label`,e)},[()=>k(`Interactive 3D memory field`)]),i(`click`,Q,W),i(`pointerdown`,Q,Qe),i(`pointermove`,Q,$e),i(`pointerup`,Q,et),o(`pointercancel`,Q,tt),o(`wheel`,Q,nt),t(n,Ot),ie(),ae()}n([`click`,`pointerdown`,`pointermove`,`pointerup`,`input`,`change`]);export{Un as t};