import{$ as e,A as t,M as n,O as r,Q as i,R as a,W as o,X as s,Y as c,Z as l,a as u,c as d,dt as f,et as p,f as m,ht as h,k as g,n as _,r as v,tt as y,ut as b}from"./BAUNE5Zx.js";import"./xihTtKlq.js";import{t as x}from"./BzAMLulQ.js";function S(e){let t=1779033703^e.length;for(let n=0;n<e.length;n++)t=Math.imul(t^e.charCodeAt(n),2654435761),t=t<<13|t>>>19;return function(){let e=t+=1831565813;return e=Math.imul(e^e>>>15,e|1),e^=Math.imul(e^e>>>7,e|61),((e^e>>>14)>>>0)/4294967296}}function C(e){return function(){let t=e+=1831565813;return t=Math.imul(t^t>>>15,t|1),t^=Math.imul(t^t>>>7,t|61),((t^t>>>14)>>>0)/4294967296}}var w=class{fps;loopFrames;seedStr;_frame;_totalFrames;_rng;constructor(e){this.fps=e.fps??60,this.loopFrames=e.loopFrames??720,this.seedStr=e.seed,this._frame=0,this._totalFrames=0;let t=S(this.seedStr)();this._rng=C(Math.floor(t*2**32))}tick(){return this._frame=(this._frame+1)%this.loopFrames,this._totalFrames++,this.state}get state(){return{frame:this._frame,phase:this._frame/this.loopFrames,rng:this._rng,totalFrames:this._totalFrames}}reset(){this._frame=0,this._totalFrames=0;let e=S(this.seedStr)();this._rng=C(Math.floor(e*2**32))}get loopDuration(){return this.loopFrames/this.fps}get framesPerLoop(){return this.loopFrames}};function T(e,t,n,r){let i=Math.PI*(3-Math.sqrt(5)),a=1-e/(t-1||1)*2,o=Math.sqrt(1-a*a),s=i*e,c=Math.cos(s)*o,l=Math.sin(s)*o,u=(r()-.5)*.1*n,d=(r()-.5)*.1*n,f=(r()-.5)*.1*n;return[c*n+u,a*n+d,l*n+f]}var E=[`recall-path`,`engram-birth`,`salience-rescue`,`forgetting-horizon`,`firewall`];function D(e){return E.includes(e)}var O={posRadius:0,velRetention:4,colorFlags:8,demo:12},k={isCenter:1,suppressed:2,isAha:4,isFailure:8,isConfusion:16},A={recall:0,backwardCause:1,probe:2},j={none:0,firewall:1,dreamStorm:2,causalRecall:3,birth:4},M={frame:0,loopPhase:1,nodeCount:2,edgeCount:3,pathCount:4,pulse:5,viewportW:6,viewportH:7,brightness:8,demoId:9,time:10,captureMode:11,liveKind:12,liveFrame:13,liveEnergy:14,projectionDays:15,cursorX:16,cursorY:17,cursorVx:18,cursorVy:19};function N(e){let t=E.indexOf(e);return t<0?0:t}function P(e,t){return{id:e.id,index:t,label:e.label,type:e.type,retention:typeof e.retention==`number`?e.retention:0,tags:Array.isArray(e.tags)?e.tags:[],isCenter:!!e.isCenter,suppressed:(e.suppression_count??0)>0,stability:typeof e.stability==`number`?e.stability:void 0,lastAccessed:typeof e.lastAccessed==`string`?e.lastAccessed:void 0,createdAt:typeof e.createdAt==`string`?e.createdAt:void 0}}function F(e,t){let n=Math.max(1,e>>1),r=Math.max(1,t>>1),i=Math.min(6,Math.max(1,1+Math.floor(Math.log2(Math.min(n,r)/8))));return{baseW:n,baseH:r,mipCount:i,sizes:Array.from({length:i},(e,t)=>[Math.max(1,n>>t),Math.max(1,r>>t)])}}var I=.18,L=`
// Tuning constants — interpolated from post.wgsl.ts (TS single source of truth).
const BLOOM_STRENGTH: f32 = ${I};
